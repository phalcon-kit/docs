...
* Full name: `\PhalconKit\Mvc\Model`
* Parent class: [`Model`](https://docs.phalcon.io/latest/api/){:target="_blank"}
* This class implements:
  [`\PhalconKit\Mvc\ModelInterface`](./ModelInterface.md)
...
### writeLocalizedProperty

```php
private writeLocalizedProperty(string $property, mixed $value): bool
```
...
```php
private readLocalizedProperty(string $property, bool& $found): mixed
```
...
### isModelRelationAlias

```php
private isModelRelationAlias(string $property): bool
```
...
### readDeclaredRelationAlias

```php
private readDeclaredRelationAlias(string $property, bool& $found): mixed
```
...
### getNullableMappedAttributes

```php
private getNullableMappedAttributes(): list<string>
```
...
```php
private isSqlNullString(mixed $value): bool
```
...
### normalizeNullableNullStringSnapshots

```php
private normalizeNullableNullStringSnapshots(list<string> $nullableAttributes): void
```
...
| Parameter             | Type             | Description |
|-----------------------|------------------|-------------|
| `$nullableAttributes` | **list<string>** |             |

***

### normalizeNullableNullStringData

```php
private normalizeNullableNullStringData(array<string,mixed> $data, list<string> $nullableAttributes): array<string,mixed>
```
