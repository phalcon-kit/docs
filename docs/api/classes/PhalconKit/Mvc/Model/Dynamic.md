...
* Full name: `\PhalconKit\Mvc\Model\Dynamic`
* Parent class: [`\PhalconKit\Mvc\Model`](../Model.md)
...
```php
public setDynamicSource(string $table): void
```
...
### requireDynamicMetaData

Require native Phalcon metadata for dynamic model cache invalidation.

```php
protected requireDynamicMetaData(mixed $modelsMetaData): \Phalcon\Mvc\Model\MetaData
```
...
| Parameter         | Type      | Description                           |
|-------------------|-----------|---------------------------------------|
| `$modelsMetaData` | **mixed** | Metadata service returned by Phalcon. |

**Throws:**

When the metadata service is incompatible with
...
```php
public setDynamicMetaData(array $metaData): void
```
...
```php
public setDynamicColumnMap(array $map): void
```
...
```php
public static createInstance(string $source, array $columnMap = []): \PhalconKit\Mvc\Model\Dynamic
```
