...
* Full name: `\PhalconKit\Mvc\ModelInterface`
* Parent interfaces:
  [`\PhalconKit\Mvc\Model\Interfaces\AttributeInterface`](./Model/Interfaces/AttributeInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\BehaviorInterface`](./Model/Interfaces/BehaviorInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\BlameableInterface`](./Model/Interfaces/BlameableInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\EagerLoadInterface`](./Model/Interfaces/EagerLoadInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\ExposeInterface`](./Model/Interfaces/ExposeInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\HashInterface`](./Model/Interfaces/HashInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\IdentityInterface`](./Model/Interfaces/IdentityInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\InstanceInterface`](./Model/Interfaces/InstanceInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\JsonInterface`](./Model/Interfaces/JsonInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\LocaleInterface`](./Model/Interfaces/LocaleInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\MetaDataInterface`](./Model/Interfaces/MetaDataInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\OptionsInterface`](./Model/Interfaces/OptionsInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\PositionInterface`](./Model/Interfaces/PositionInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\RelationshipInterface`](./Model/Interfaces/RelationshipInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\ReplicationInterface`](./Model/Interfaces/ReplicationInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\SecurityInterface`](./Model/Interfaces/SecurityInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\SlugInterface`](./Model/Interfaces/SlugInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\SnapshotInterface`](./Model/Interfaces/SnapshotInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\SoftDeleteInterface`](./Model/Interfaces/SoftDeleteInterface.md),
  [`\PhalconKit\Mvc\Model\Interfaces\ValidateInterface`](./Model/Interfaces/ValidateInterface.md),
  `ModelInterface`
