...
* Full name: `\PhalconKit\Models\File`
* Parent class: [`\PhalconKit\Models\Abstracts\FileAbstract`](./Abstracts/FileAbstract.md)
* This class implements:
  [`\PhalconKit\Models\Interfaces\FileInterface`](./Interfaces/FileInterface.md)
...
```php
public setMimeType(mixed $mimeType): void
```
