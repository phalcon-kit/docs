...
* Full name: `\PhalconKit\Models\AbstractModel`
* Parent class: [`\PhalconKit\Mvc\Model`](../Mvc/Model.md)
...
|-----------|------------|--------|----------------------------|
| `YES`     | public     | int    | \PhalconKit\Db\Column::YES |
| `NO`      | public     | int    | \PhalconKit\Db\Column::NO  |
| `LANG_EN` | public     | string | 'en'                       |
| `LANG_FR` | public     | string | 'fr'                       |
| `LANG_SP` | public     | string | 'sp'                       |
