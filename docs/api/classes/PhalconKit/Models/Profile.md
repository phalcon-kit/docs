...
* Full name: `\PhalconKit\Models\Profile`
* Parent class: [`\PhalconKit\Models\Abstracts\ProfileAbstract`](./Abstracts/ProfileAbstract.md)
* This class implements:
  [`\PhalconKit\Models\Interfaces\ProfileInterface`](./Interfaces/ProfileInterface.md)
...
```php
public setAvatarFileId(mixed $avatarFileId): void
```
