...
* Full name: `\PhalconKit\Models\User`
* Parent class: [`\PhalconKit\Models\Abstracts\UserAbstract`](./Abstracts/UserAbstract.md)
* This class implements:
  [`\PhalconKit\Models\Interfaces\UserInterface`](./Interfaces/UserInterface.md)
...
```php
public setResetToken(mixed $resetToken): void
```
