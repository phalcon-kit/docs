...
* Full name: `\PhalconKit\Models\Email`
* Parent class: [`\PhalconKit\Models\Abstracts\EmailAbstract`](./Abstracts/EmailAbstract.md)
* This class implements:
  [`\PhalconKit\Models\Interfaces\EmailInterface`](./Interfaces/EmailInterface.md)
...
```php
public setReplyTo(mixed $replyTo): void
```
...
```php
public setReturnPath(mixed $returnPath): void
```
