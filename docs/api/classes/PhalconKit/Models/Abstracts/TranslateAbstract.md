...
* Full name: `\PhalconKit\Models\Abstracts\TranslateAbstract`
* Parent class: [`\PhalconKit\Models\AbstractModel`](../AbstractModel.md)
* This class implements:
  [`\PhalconKit\Models\Abstracts\Interfaces\TranslateAbstractInterface`](./Interfaces/TranslateAbstractInterface.md)
...
```php
public mixed $translatableTable
```
...
```php
public getTranslatableTable(): mixed
```

***

### setTranslatableTable
...
```php
public setTranslatableTable(mixed $translatableTable): void
```
...
```php
public getTranslatableId(): mixed
```
...
```php
public setTranslatableId(mixed $translatableId): void
```
