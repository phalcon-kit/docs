...
* Full name: `\PhalconKit\Models\Data`
* Parent class: [`\PhalconKit\Models\Abstracts\DataAbstract`](./Abstracts/DataAbstract.md)
* This class implements:
  [`\PhalconKit\Models\Interfaces\DataInterface`](./Interfaces/DataInterface.md)
...
```php
public setRecordId(mixed $recordId): void
```
...
```php
public setColumnId(mixed $columnId): void
```
