...
* Full name: `\PhalconKit\Models\Session`
* Parent class: [`\PhalconKit\Models\Abstracts\SessionAbstract`](./Abstracts/SessionAbstract.md)
* This class implements:
  [`\PhalconKit\Models\Interfaces\SessionInterface`](./Interfaces/SessionInterface.md)
...
```php
public setExpiresAt(mixed $expiresAt): void
```
