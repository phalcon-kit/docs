...
* Full name: `\PhalconKit\Models\Job`
* Parent class: [`\PhalconKit\Models\Abstracts\JobAbstract`](./Abstracts/JobAbstract.md)
* This class implements:
  [`\PhalconKit\Models\Interfaces\JobInterface`](./Interfaces/JobInterface.md)
...
```php
public setRunAt(mixed $runAt): void
```
