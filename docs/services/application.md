...
The Application Service in Phalcon Kit operates at the heart of the MVC architecture. It serves as the entry point for web
...
A key feature of Phalcon Kit's Application Service is its integration with the Dependency Injection (DI) system. The Core
...
For an in-depth understanding of the functionalities and usage of the Core Application Component within Phalcon Kit's
Application Service, refer to the [Phalcon Kit Application Component documentation](../../core/application/). This
...
```ini
PROVIDER_APPLICATION=\PhalconKit\Provider\Application\ServiceProvider
```
...
!!! info "Application Service Provider"
    ...
    [`\PhalconKit\Provider\Application\ServiceProvider`](https://github.com/phalcon-kit/core/blob/master/src/Provider/Application/ServiceProvider.php){:target="_blank"}
